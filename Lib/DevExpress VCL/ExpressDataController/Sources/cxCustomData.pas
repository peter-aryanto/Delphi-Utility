...
//    function GetRecordCount: Integer; virtual;
  ...
  private
    ...
    function GetFilteredIndexByRecordIndex(Index: Integer): Integer; inline;
    function GetFilteredRecordCount: Integer; inline;
...
begin
  if IsConditionsLowerCase then
    ...
    ASearchText := Text;
  Conditions.Refresh(ASearchText{FUpperText}, UseExtendedSyntax);
end;
