...
begin
  ...
  if Assigned(OnNavigateComplete) then
    OnNavigateComplete(URL, AComplete);
  if AComplete then
...
begin
  ...
  try
    ...
    FAuthorizationForm := TdxAuthorizationForm.CreateEx;
    FAuthorizationForm.Navigate(AUri);
    FAuthorizationForm.OnNavigateComplete := AuthorizationFormNavigateCompleteHandler;
