...
type
  ...
  public
    ...
    procedure Offset(const DX, DY: Single); overload; inline;
    procedure Offset(const P: TdxPointF); overload; inline;
    procedure Offset(const S: TdxSizeF); overload; inline;
  end;
  ...
  public
    Height: Double;
    Width: Double;
    class function Create(const AWidth, AHeigth: Double): TdxSizeDouble; static; inline;
...
procedure TdxPointF.Offset(const DX, DY: Single);
begin
  X := X + DX;
  Y := Y + DY;
end;

procedure TdxPointF.Offset(const P: TdxPointF);
begin
  X := X + P.X;
  Y := Y + P.Y;
end;

procedure TdxPointF.Offset(const S: TdxSizeF);
begin
  X := X + S.cx;
  Y := Y + S.cy;
end;
...
class function TdxSizeDouble.Create(const AWidth, AHeigth: Double): TdxSizeDouble;
begin
  Result.Width := AWidth;
  Result.Height := AHeigth;
end;
...
procedure TdxPointDouble.Offset(const DX, DY: Single);
begin
  X := X + DX;
  Y := Y + DY;
end;
