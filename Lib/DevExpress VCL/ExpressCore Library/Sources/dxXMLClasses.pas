...
type
  ...
  strict private
    ...
    class var
      ...
      class procedure InitRanges(const ARanges: string; Attribyte: Byte); static;
  public
...
class procedure TdxXmlCharType.InitRanges(const ARanges: string; Attribyte: Byte);
var
  P: PChar;
  AChar, AEndChar: Char;
  L: Integer;
begin
  ...
  begin
    ...
    begin
      FCharProperties[AChar] := FCharProperties[AChar] or Attribyte;
      Inc(AChar);
    end;
    Inc(P);
    Dec(L, 2);
