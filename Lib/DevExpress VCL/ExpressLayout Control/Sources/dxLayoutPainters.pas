...
begin
  ...
  LookAndFeelPainter.DrawGroupBoxFrame(ACanvas, AFrameBounds, ViewInfo.Enabled, dxCaptionPositionMap[AHasCaption, AGroupViewInfo.CaptionSide]);
  ...
  begin
    ...
    LookAndFeelPainter.DrawGroupBoxCaption(ACanvas, ACaptionRect,
      ViewInfo.CaptionViewInfo.Bounds, dxCaptionPositionMap[True, AGroupViewInfo.CaptionSide]);
  end;
end;
