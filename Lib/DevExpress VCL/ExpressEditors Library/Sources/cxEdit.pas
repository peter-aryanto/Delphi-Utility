...
type
  ...
  TcxEditSupportedOperation = (esoAlwaysHotTrack, esoAutoHeight, esoEditing,
    ...
    esoEditingAutoHeight, esoNeedHandle);
  ...
  private
    ...
    function DoDrawButtonBorder(ACanvas: TcxCanvas; AViewInfo: TcxEditButtonViewInfo; out ABackgroundRect, AContentRect: TRect): Boolean;
  ...
  protected
    ...
    procedure CheckCursor(const AMousePos: TPoint); virtual; 
...
//    property GradientButtons;
  ...
  public
    ...
    function GetDisplayText(const AEditValue: TcxEditValue; AFullText: Boolean = False; AIsInplace: Boolean = True): WideString; virtual;
...
procedure TcxCustomEditViewInfo.CheckCursor;
begin
end;
...
begin
  Result := Properties.Buttons[AViewInfo.ButtonsInfo[AButtonVisibleIndex].ButtonIndex].LeftAlignment;
end;
