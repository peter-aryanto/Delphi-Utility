...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, SysUtils, Variants, Classes, Graphics,
...
function TdxDateTimeWheelPickerProperties.GetDisplayText(const AEditValue: Variant; AFullText, AIsInplace: Boolean): WideString;
var
...
function TdxCustomDateTimeWheelPicker.GetDisplayValue: string;
begin
