...
uses
  ...
  dxCore, cxLookAndFeelPainters, cxGraphics, cxButtons, cxControls, cxFilterControl, cxLookAndFeels, dxForms;
...
begin
  ...
  try
    ...
    if ALookAndFeel.SkinPainter = nil then
      AForm.SetPanelsColor(AForm.FilterControl.Color)
    else
      AForm.SetPanelsColor(ALookAndFeel.SkinPainter.DefaultContentColor);
