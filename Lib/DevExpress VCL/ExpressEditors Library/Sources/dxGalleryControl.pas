...
begin
  ...
  if ACanvas.RectVisible(R) then
    cxTextOut(ACanvas.Canvas, AViewInfo.Caption, R,
      ...
      nil, 0, 0, 0, GetItemCaptionTextColor(AViewInfo));
  ...
  if ACanvas.RectVisible(R) then
    cxTextOut(ACanvas.Canvas, AViewInfo.Description, R,
      ...
      nil, 0, 0, 0, GetItemDescriptionTextColor(AViewInfo));
end;
...
begin
  case AKey of
    VK_RIGHT:
      SelectNextItem(GetStartItemForKeyboardNavigation, 1, 0, AShift);
    VK_LEFT:
      SelectNextItem(GetStartItemForKeyboardNavigation, -1, 0, AShift);
    VK_UP:
...
begin
  if (AItem <> nil) and AItem.Group.Visible then
    Owner.MakeVisible(AItem.ViewInfo.Bounds, vtFully);
end;
