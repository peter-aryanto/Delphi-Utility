...
uses
  ...
  cxLookAndFeelPainters, cxDataUtils, cxVariants, dxTouch, dxSkinsCore, dxCoreGraphics,
...
begin
  ...
  begin
    R := cxRectOffset(cxGetImageRect(CR, dxGetImageSize(Picture, ScaleFactor), FitMode, Center, ZoomPercent), TopLeft, False);
