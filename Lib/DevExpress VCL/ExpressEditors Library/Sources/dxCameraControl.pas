...
begin
  ...
  cxDrawText(ACanvas.Handle, FCaption, ARect, DT_LEFT or DT_VCENTER or DT_SINGLELINE);
  cxDrawText(ACanvas.Handle, FDescription, ARect, DT_RIGHT or DT_VCENTER or DT_SINGLELINE);
end;
...
begin
  ...
  begin
    ...
    FColumnCount := Ceil(Sqrt(Result.cy * Result.cx) / Result.cx);
  end;
