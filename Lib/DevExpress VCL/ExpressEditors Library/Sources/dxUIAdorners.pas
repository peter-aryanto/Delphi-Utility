...
type
  ...
  TdxGuideGetCalloutPopupControl = procedure(AManager: TdxUIAdornerManager; AGuide: TdxGuide; out AControl: TWinControl) of object;
...
var
  ARect: TRect;
begin
  ARect := TargetElement.ScreenBounds;
