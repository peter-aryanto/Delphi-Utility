...
type
  ...
  public
    ...
    function GetDisplayText(const AEditValue: Variant; AFullText, AIsInplace: Boolean): WideString; override;
...
function TdxCustomNumericWheelPickerProperties.GetDisplayText(const AEditValue: Variant;
  AFullText, AIsInplace: Boolean): WideString;
var
...
function TdxCustomNumericWheelPicker.GetDisplayValue: string;
var
  ADisplayValue: TcxEditValue;
begin
