...
begin
  Painter.DrawAlertWindowScaledButton(ACanvas, Bounds, State, Kind, ScaleFactor);
end;
...
begin
  ...
  AAlertWindow.BoundsRect := GetNewPosition(AAlertWindow.BoundsRect,
    GetLastInitialGrid(Position, AMonitor.MonitorNum), Position,
    GetMonitorWorkArea(AMonitor.Handle), AColumnIndex);
  PositionInfoList.Add(AAlertWindow, Position, AMonitor.MonitorNum).ColumnIndex := AColumnIndex;
end;
