...
begin
  ...
  begin
    ...
    FButtonRect := Classes.Bounds(ARowRect.Left + ScaleFactor.Apply(4) + Indent, 0, AWidth,
...
begin
  ...
  begin
    ...
    FBoolOperatorRect := Bounds(ButtonRect.Right + ScaleFactor.Apply(8), 0, ASize.cx + ScaleFactor.Apply(2), ASize.cy + ScaleFactor.Apply(2));
    CenterRectVert(FRowRect, FBoolOperatorRect);
    Font.Assign(Control.Font);
    ASize := TextExtent(FCaption);
    FCaptionRect := Bounds(FBoolOperatorRect.Right + ScaleFactor.Apply(8), 0, ASize.cx + ScaleFactor.Apply(2), ASize.cy + ScaleFactor.Apply(2));
...
begin
  ...
  begin
    ATopLeft := Point(Condition.OperatorRect.Right + Control.ScaleFactor.Apply(8), 0);
  ...
  begin
    ...
    FAddButtonRect := Bounds(Values[Count - 1].ValueRect.Right + Control.Canvas.TextWidth(')0'), 0, AWidth,
...
begin
  ...
  begin
    ...
    FItemRect := Bounds(ButtonRect.Right + ScaleFactor.Apply(8), 0, ASize.cx + ScaleFactor.Apply(2), ASize.cy + ScaleFactor.Apply(2));
    ...
    FOperatorRect := Bounds(FItemRect.Right + ScaleFactor.Apply(8), 0, ASize.cx + ScaleFactor.Apply(2), ASize.cy + ScaleFactor.Apply(2));
      ...
      case HitTest of
        fhtButton:
          begin
            ...
            if Row = FRoot then Dec(Result.Left, ScaleFactor.Apply(4));
          end;
