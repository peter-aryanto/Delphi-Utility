...
var
  ...
  AText: string;
  ATextRect : TRect;
  AGheckPaintHelper: TcxCheckPaintHelper;
...
begin
  ...
  AGheckPaintHelper := Edit.ActiveProperties.FCheckPaintHelper;
  AGheckPaintHelper.Glyph := AGlyph;
  AGheckPaintHelper.GlyphCount := AGlyphCount;
  ACheckBoxState := GetItemCheckState(Index);
  ATextRect := AGheckPaintHelper.CalcTextRect(Rect, ACheckBoxState);
  AText := GetItem(Index);
