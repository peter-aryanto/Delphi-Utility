...
type
  ...
  public
    ...
    // CommandLink
    procedure DrawCommandLinkButton(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState; AColor: TColor); virtual;
...
procedure TcxButtonPainter.DrawCommandLinkButton(ACanvas: TcxCanvas; const R: TRect;
  AState: TcxButtonState; AColor: TColor);
begin
