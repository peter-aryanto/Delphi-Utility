...
procedure TdxCustomAutoCompleteInnerListBox.MouseDown(
...
begin
  ...
  if IsPopupScrollBars then
    Result.Left := Result.Right - GetSizeGripSize.cx
  else
  begin
    Result.Left := Result.Right;
    Result.Right := Result.Left + GetSizeGripSize.cx;
  end;
  Result.Top := Result.Bottom - GetSizeGripSize.cy;
end;
...
begin
  ...
  Result.Bottom := Result.Bottom - GetSizeGripSize.cy;
end;
