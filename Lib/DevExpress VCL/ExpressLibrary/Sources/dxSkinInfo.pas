...
type
  ...
  public
    ...
    NavBarAccordionControlRootGroupFontBold: TdxSkinBooleanProperty;
    NavBarAccordionControlRootGroupFontSize: TdxSkinIntegerProperty;
...
begin
  ...
  NavBarAccordionControlRootGroupFontBold := GetBoolPropertyByName(NavBarAccordionControlRootGroup, sdxFontBold);
  NavBarAccordionControlRootGroupFontSize := GetIntegerPropertyByName(NavBarAccordionControlRootGroup, sdxFontSize);
