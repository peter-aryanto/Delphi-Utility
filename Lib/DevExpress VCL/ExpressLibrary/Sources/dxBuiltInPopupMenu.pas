...
{$IFDEF DELPHI16}
  UITypes,
{$ENDIF}
  Types, Menus, Classes, Graphics, cxControls, cxClasses, dxCore, ImgList, cxGraphics, cxLookAndFeels, ActnList;
...
class procedure TdxBuiltInPopupMenuAdapterHelper.AddMenu(
  ...
  begin
    ...
    begin
      AParentItem := AddMenuItem(AAdapter, AMenuItem, AClickEvent, NativeInt(AMenuItem), AParentItem);
