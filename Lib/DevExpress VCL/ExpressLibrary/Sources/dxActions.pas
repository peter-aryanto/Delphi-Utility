...
uses
  Windows, Types, SysUtils, Classes, Controls, ActnList, dxCore, cxClasses;
...
type
  ...
  protected
    ...
    function CanExecuteTarget(Target: TObject): Boolean;
...
function TdxBasicAction.CanExecuteTarget(Target: TObject): Boolean;
begin
  Result := HandlesTarget(Target) and (Target = Control);
end;
...
procedure TdxBasicAction.ResetState;
begin
  // do nothing
end;
