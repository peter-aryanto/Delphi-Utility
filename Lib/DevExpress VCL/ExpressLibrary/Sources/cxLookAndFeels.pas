...
begin
  ...
  if SameText(AIdent, 'tsmEnabled') then
    TouchScrollUIMode := tsmEnabled
  else
    if SameText(AIdent, 'tsmDisabled') then
      TouchScrollUIMode := tsmDisabled
    else
      if SameText(AIdent, 'tsmDefault') then
        TouchScrollUIMode := tsmDefault;
end;
