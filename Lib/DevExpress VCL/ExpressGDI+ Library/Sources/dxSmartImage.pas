...
type
  ...
  public
    ...
    property ImageCodec: TdxSmartImageCodecClass read GetImageCodec;
...
begin
  Result := Copy(UpperCase(Ext), 2, MaxInt) + ' graphics from DevExpress';
end;
...
begin
  if (APalette <> nil) and IsEqualGUID(FCachePaletteID, APalette.GetID) then
    FreeAndNil(FCache);
  ...
  begin
    ...
    begin
      ...
      if APalette <> nil then
        FCachePaletteID := APalette.GetID;
    end;
  end;
  Result := FCache <> nil;
end;
